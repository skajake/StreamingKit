Pod::Spec.new do |s|
  ...
  s.ios.frameworks   = 'SystemConfiguration', 'CFNetwork', 'CoreFoundation', 'AudioToolbox', 'Network', 'Security'
  s.osx.deployment_target = '10.14'
  s.osx.frameworks   = 'SystemConfiguration', 'CFNetwork', 'CoreFoundation', 'AudioToolbox', 'AudioUnit', 'Network', 'Security'
end
